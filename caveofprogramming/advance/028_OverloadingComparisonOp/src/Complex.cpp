...
/**
 * @brief Oveload Comparison Operator "=="
 * @param other - the object to be compared with this one object
 * @return boolean saying if this object is equals to an other object
 */
 ...
 * @brief Oveload Comparison Operator "!="
 * @param other - the object to be compared with this one object
 * @return boolean saying if this object is NOT equal to an other object
 */
bool Complex::operator !=(const Complex& other) const
{
	return !(*this==other);
